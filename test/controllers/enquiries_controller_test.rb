...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { email: @enquiry.email, first_name: @enquiry.first_name, last_name: @enquiry.last_name, message: @enquiry.message, phone: @enquiry.phone, reason: @enquiry.reason }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { email: @enquiry.email, first_name: @enquiry.first_name, last_name: @enquiry.last_name, message: @enquiry.message, phone: @enquiry.phone, reason: @enquiry.reason }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
